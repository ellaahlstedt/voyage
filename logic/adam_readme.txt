...
- Om ni vill hämta alla regioner/länder/städer så behöver ni bara en göra en GET-request som innehåller parametern TYPE. Parametern måste antingen vara region, country, city.	
...
- Om ni vill hämta alla länder som tillhör en viss region eller alla städer som tillhör ett visst land då MÅSTE ni ange en till parameter som heter "all" som måste vara TRUE.
	EXEMPEL:
